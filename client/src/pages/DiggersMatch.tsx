...
import handsHeartImage from '@assets/360_F_854499176_sbmU8CqMpL0O18JjL40wMPNJzd4pNWEw.jpg';
import coupleImage from '@assets/1000_F_663771771_aa8TxQ2mYeUPRnDLfo4qFN0rX5Dpp8PO.jpg';
        ...
        <div className="mb-16 text-center">
          <div className="max-w-4xl mx-auto">
            <div className="relative overflow-hidden rounded-xl shadow-lg">
              <img 
                src={handsHeartImage}
                alt="Hands forming a heart shape against sunset"
          ...
          <div className="text-center mb-12">
            <div className="max-w-lg mx-auto">
              <div className="relative overflow-hidden rounded-lg shadow-md">
                <img 
                  src={coupleImage}
                  alt="Happy couple watching sunset together"
                  className="w-full h-48 object-cover"
                  loading="lazy"
                />
                <div className="absolute inset-0 bg-black/20 flex items-end">
                  <div className="text-center text-white p-4 w-full">
                    <p className="text-lg font-semibold">"Found Love & Treasure Together"</p>
                  </div>
                </div>
              </div>
            </div>
