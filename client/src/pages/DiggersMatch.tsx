...
import heartHandsImage from "@/assets/heart-hands-sunset.jpg";
import coupleSunsetImage from "@/assets/couple-sunset-lake.jpg";
      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        ...
        <div className="mb-16 text-center">
          <div className="max-w-4xl mx-auto">
            <div 
              className="relative overflow-hidden rounded-xl shadow-lg h-64 flex items-center justify-center"
              style={{
                backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3)), url(${heartHandsImage})`,
            ...
            >
              <div className="text-center text-white">
                <h3 className="text-2xl font-bold mb-2">Find Love Through Shared Passion</h3>
                <p className="text-lg">Where hearts and treasure hunting unite</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mb-16">
          ...
          <div className="text-center mb-12">
            <div className="max-w-lg mx-auto">
              <div 
                className="relative overflow-hidden rounded-lg shadow-md h-48 flex items-center justify-center"
                style={{
                  backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.4)), url(${coupleSunsetImage})`,
                  backgroundSize: 'cover',
                  backgroundPosition: 'center',
                  backgroundRepeat: 'no-repeat'
                }}
              >
                <div className="text-center text-white">
                  <p className="text-xl font-bold mb-2">"Found Love & Treasure Together"</p>
                  <p className="text-sm">Join thousands of successful detecting couples</p>
                </div>
              </div>
            </div>
          </div>
