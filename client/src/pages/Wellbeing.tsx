          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-forest-green/70 p-6 rounded-lg border border-metallic-gold">
              ...
              <ul className="space-y-4">
                <li className="border-l-4 border-metallic-gold pl-3 py-1 bg-white/10 rounded p-3">
                  <h4 className="font-semibold text-white">Mindful Detecting Retreat</h4>
                  <p className="text-sand-beige/90">June 15 • Lake District</p>
                  <p className="text-sand-beige/80 mt-1">A weekend of guided mindful detecting, meditation, and relaxation.</p>
                </li>
                <li className="border-l-4 border-metallic-gold pl-3 py-1 bg-white/10 rounded p-3">
                  <h4 className="font-semibold text-white">Beginners Wellbeing Workshop</h4>
                  <p className="text-sand-beige/90">July 10 • Yorkshire Dales</p>
                  <p className="text-sand-beige/80 mt-1">Learn detecting basics with a focus on mindfulness and stress relief.</p>
                </li>
                <li className="border-l-4 border-metallic-gold pl-3 py-1 bg-white/10 rounded p-3">
                  <h4 className="font-semibold text-white">Beach Therapy Day</h4>
                  <p className="text-sand-beige/90">July 24 • Cornwall Coast</p>
                  <p className="text-sand-beige/80 mt-1">Combine the calming effects of the ocean with metal detecting.</p>
                </li>
              </ul>
            </div>
