...
export function useAuth() {
  ...
  useEffect(() => {
    ...
    try {
      ...
      // If this is the first visit (new deployment), don't auto-login
      if (isFirstVisit) {
        console.log("First visit detected - not auto-logging in");
      ...
      // Normal login process for returning visitors
