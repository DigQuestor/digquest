  ...
  const register = async (username: string, email: string, password: string, profilePicture?: File) => {
    try {
      ...
      toast({
        ...
        description: "Check your email now and click the verification link. You must verify your email before you can log in to DigQuest.",
        duration: 10000,
      });
          ...
          <DialogDescription className="text-center">
            {currentStep === 'account' && (
              <div className="space-y-2">
                <p>Fill out your details below. You must verify your email address before you can log in.</p>
                <div className="bg-amber-50 border border-amber-200 rounded-md p-3 text-sm">
                  <p className="text-amber-800 font-medium">📧 Important: Check your spam/junk folder!</p>
                  <p className="text-amber-700">Our verification emails sometimes end up in spam folders. Please check all email folders after signing up.</p>
                </div>
              </div>
            )}
                ...
                <div className="flex flex-col space-y-2 mt-2">
                  ...
                  >
                    {isLoading ? (
                      ...
                      <>
                        {watchDonationOption === "skip" ? "Send Verification Email" : "Continue to Payment"}
                      </>
                    )}
                  </Button>
