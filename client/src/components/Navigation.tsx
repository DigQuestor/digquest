      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <Link href="/diggers-match" 
            className={`whitespace-nowrap transition-colors duration-300 px-3 py-2 font-medium flex items-center text-sm md:text-base relative flex-shrink-0 min-w-fit
