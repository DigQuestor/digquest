    ...
    <section className="mb-6 md:mb-12">
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-4 md:mb-6 gap-2">
        ...
        <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 items-start sm:items-center">
          {user && (
            <Link href="/finds" asChild>
              <Button 
                className="bg-forest-green hover:bg-green-700 text-white font-semibold transition-all duration-300 flex items-center text-sm md:text-base px-3 md:px-4 py-2 w-full sm:w-auto"
              >
